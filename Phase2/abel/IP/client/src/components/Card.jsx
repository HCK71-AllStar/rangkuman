  ...
  return (
    <>
      <div className="w-full md:w-1/2 xl:w-1/3 px-4">
        <div className="bg-white rounded-lg overflow-hidden mb-10 pt-10" style={{ textAlign: "-webkit-center" }}>
          {/* <img src={imgUrl} style={{ width: "100%", height: "300px" }} /> */}
          <img src={imgUrl} style={{ width: "400px", height: "300px", borderRadius: "4px" }} />
